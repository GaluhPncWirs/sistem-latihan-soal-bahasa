            ...
            <div className="mb-7">
              ...
              {resultExam.length > 0 ? (
                <table className="border-collapse w-full">
                  <thead>
                    <tr className="bg-[#3282B8] border-2 border-black">
                      <th className="text-slate-100 p-2">Nama Ujian</th>
                      <th className="text-slate-100 p-2">Status Ujian</th>
                    </tr>
                  </thead>
                  {resultExam.flatMap((tes: any, i: number) => (
                    <tbody key={i}>
                      <tr className="border-2 border-black">
                        <td className="px-3 bg-stone-100">{tes.nama_ujian}</td>
